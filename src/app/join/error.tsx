...
/** Error boundary for /join/*. Friendly recovery, never a redirect. */
export default function PlansError({ reset }: { error: Error; reset: () => void }) {
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-md flex-col items-center justify-center gap-3 px-6 text-center">
      ...
      <p className="text-sm text-muted-foreground">This invite link isn&apos;t working right now — ask for it again, or start your own plan.</p>
